    ...
    <div>
      <section class="collegeEventDesc">
        ...
        <div class="eventTopContent">
          Hetauda City College frequently holds different events that can have a
          number of benefits for students, staff, and the wider college
          community. One of the main benefits of holding events is that they
          provide opportunities for students to get involved in extracurricular
          activities. This can be beneficial for their overall college
          experience, as it allows them to explore their interests and passions
          outside of the classroom. Additionally, participating in events can
          help students develop important skills such as leadership, teamwork,
          and communication. They can foster a sense of community within the
          college. This can be especially important for students who are new to
          the college and may be feeling a bit overwhelmed.
        </div>
      </section>
      <section class="mainEvents">
        ...
        <form action="/notices/new?_method=GET" method="post">
          <button class="btn eventBtn" type="submit">
            Add Event
          </button>
        </form>
        {/* <%}%> */}
          ...
          <div class="event">
            ...
            <div class="eventInfoContainer">
              ...
              <div class="deleteAndEdit">
                <form
                  action="<%='/notices/'+article._id%>?_method=DELETE"
                  method="POST"
                >
                  <button
                    type="button"
                    class="btn deleteBtn"
                    onclick="askToDeleteEvent(this.parentNode)"
                  >
                    <i class="fa fa-trash-o" aria-hidden="true"></i>{" "}
                    <span class="delTxt">Delete</span>
                  </button>
                </form>
